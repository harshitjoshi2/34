...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope = new Rope(8,{x:120,y:200});
   rope2 = new Rope(7,{x:490,y:300});

star=createSprite(480,180,20,20);
star.addImage(starImg);
star.scale=0.02;

star2=createSprite(150,450,20,20);
star2.addImage(starImg);
star2.scale=0.02;

blower=createImg("baloon2.png");
blower.position(240,400);
blower.size(120,120);
...
{
  background(51);
  image(bg_img,0,0,width,height-10);
...
function airBlow(){
    Matter.Body.applyForce(fruit,{x:0,y:0},{x:0.03,y:-0.03});
    air.play();
}